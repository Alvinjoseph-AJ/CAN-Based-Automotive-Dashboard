...
void main(void) {
    ...
    clcd_print("SP G TM RPM  IN", (0x80 + (0)));
    ...
    while (1) {
        ...
        if (msg_id == 0x20) {
            clcd_putch(data, (0xC0 + (3)));
        }
        if (msg_id == 0x10) {
            clcd_putch(data / 10 + 48, (0xC0 + (0)));
            clcd_putch(data % 10 + 48, (0xC0 + (1)));
        }
        if (msg_id == 0x40) {
            clcd_putch(data / 10 + 48, (0xC0 + (5)));
            clcd_putch(data % 10 + 48, (0xC0 + (6)));
        }
        if (msg_id == 0x30) {
            clcd_putch(((data * 60) / 1000) + '0', (0xC0 + (8)));
            clcd_putch((((data * 60) / 100) % 10) + '0', (0xC0 + (9)));
            clcd_putch((((data * 60) / 10) % 10) + '0', (0xC0 + (10)));
            clcd_putch(((data * 60) % 10) + '0', (0xC0 + (11)));
        }
        if (msg_id == 0x50) {
